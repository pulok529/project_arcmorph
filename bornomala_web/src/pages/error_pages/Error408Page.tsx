...
export const Error408Page: React.FC = () => {
  return (
    <div>
      <PageHeader title="Error 408" category="Error Pages" />

      <div className="row">
        <div className="col-12">
          <Card title="Error 408 Showcase" badge={<span className="badge badge-soft-primary fs-xs">Active</span>}>
            <div className="p-3 bg-light rounded mb-4 d-flex align-items-center gap-3">
              ...
              <div>
                <h5 className="mb-1 fw-bold">Error 408</h5>
