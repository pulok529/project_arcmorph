...
export const UiButtonsPage: React.FC = () => {
  return (
    <div>
      ...
      <div className="row">
        <div className="col-12">
          <Card title="Buttons Showcase" badge={<span className="badge badge-soft-primary fs-xs">Active</span>}>
            <div className="p-3 bg-light rounded mb-4 d-flex align-items-center gap-3">
              ...
              <div>
                <h5 className="mb-1 fw-bold">Buttons</h5>
