...
export const PagesEmptyPage: React.FC = () => {
  return (
    <div>
      <PageHeader title="Starter" category="Pages" />

      <div className="row">
        <div className="col-12">
          <Card title="Starter Showcase" badge={<span className="badge badge-soft-primary fs-xs">Active</span>}>
            <div className="p-3 bg-light rounded mb-4 d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted mb-0 fs-sm">Enterprise UI module for Pages &mdash; clean responsive React component.</p>
              </div>
            </div>
