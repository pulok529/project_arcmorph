...
export const LayoutsSidebarNoIconsPage: React.FC = () => {
  return (
    <div>
      <PageHeader title="No Icons with Lines" category="Layouts" />

      <div className="row">
        <div className="col-12">
          <Card title="No Icons with Lines Showcase" badge={<span className="badge badge-soft-primary fs-xs">Active</span>}>
            <div className="p-3 bg-light rounded mb-4 d-flex align-items-center gap-3">
              ...
              <div>
                <h5 className="mb-1 fw-bold">No Icons with Lines</h5>
                <p className="text-muted mb-0 fs-sm">Enterprise UI module for Layouts &mdash; clean responsive React component.</p>
              </div>
            </div>
