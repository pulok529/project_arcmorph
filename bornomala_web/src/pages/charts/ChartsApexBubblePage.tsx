...
export const ChartsApexBubblePage: React.FC = () => {
  ...
  return (
    <div>
      <PageHeader title="Bubble Apexcharts" category="Charts" />

      <div className="row">
        <div className="col-lg-6">
          <Card title="Primary Bubble Apexcharts">
            <div className="py-2">
              <ReactApexChart
        ...
        <div className="col-lg-6">
          <Card title="Secondary Bubble Apexcharts">
            <div className="py-2">
              <ReactApexChart
                options={{
                  ...chartOptions,
