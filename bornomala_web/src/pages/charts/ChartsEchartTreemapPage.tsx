...
export const ChartsEchartTreemapPage: React.FC = () => {
  const option1 = {
    title: { text: 'Area Echart Overview', left: 'center', textStyle: { color: '#6c757d', fontSize: 14 } },
    ...
    <div>
      ...
      <div className="row">
        <div className="col-lg-6">
          <Card title="Primary Area Echart">
            <ReactECharts option={option1} style={{ height: 350, width: '100%' }} />
          </Card>
        </div>

        <div className="col-lg-6">
          <Card title="Secondary Area Echart">
