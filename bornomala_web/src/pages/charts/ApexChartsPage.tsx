...
export const ApexChartsPage: React.FC = () => {
  return (
    <div>
      <PageHeader title="ApexCharts" category="Charts" />

      <div className="row">
        <div className="col-lg-8">
          <Card title="ApexCharts Overview" badge={<span className="badge badge-soft-primary fs-xs">Active</span>}>
            <div className="d-flex align-items-center gap-3 p-3 bg-light rounded mb-4">
              <span className="avatar-md bg-primary text-white rounded d-flex align-items-center justify-content-center" style={{ width: 48, height: 48 }}>
                <i className="ti-chart-donut fs-24"></i>
              </span>
              <div>
                <h5 className="mb-1 fw-bold">ApexCharts Component</h5>
                <p className="text-muted mb-0 fs-sm">Comprehensive spline, bar, candlestick, and radial charts.</p>
              </div>
            </div>
          ...
          <Card title="Quick Info">
            <ul className="list-group list-group-flush">
              <li className="list-group-item d-flex justify-content-between align-items-center px-0">
                <span>Category</span>
                <span className="badge badge-soft-info">Charts</span>
              </li>
              <li className="list-group-item d-flex justify-content-between align-items-center px-0">
