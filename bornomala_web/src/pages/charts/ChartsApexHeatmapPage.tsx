...
export const ChartsApexHeatmapPage: React.FC = () => {
  ...
  return (
    <div>
      <PageHeader title="Heatmap Apexcharts" category="Charts" />

      <div className="row">
        <div className="col-lg-6">
          <Card title="Primary Heatmap Apexcharts">
            <div className="py-2">
              <ReactApexChart
        ...
        <div className="col-lg-6">
          <Card title="Secondary Heatmap Apexcharts">
            <div className="py-2">
              <ReactApexChart
                options={{
                  ...chartOptions,
