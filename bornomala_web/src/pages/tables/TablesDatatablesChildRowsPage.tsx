...
export const TablesDatatablesChildRowsPage: React.FC = () => {
  return (
    <div className="page-wrapper-module">
      <PageHeader title="Child Rows DataTables" category="Tables" />

      <div className="module-content-body">
        <div className="row">
          <div className="col-12">
            <Card title="Child Rows DataTables" badge={<span className="badge badge-soft-primary fs-xs">Live Interactive</span>}>
              <ReactDataTable
                ...
                renderExpandedRow={(row) => (
                  <div className="p-3 bg-light rounded border">
                    <h6 className="fw-bold fs-sm mb-2 text-primary">{row.company} ({row.symbol}) - Details</h6>
                    <div className="row g-2 fs-xs">
                      <div className="col-md-3"><strong>Current Price:</strong> {row.price}</div>
                      <div className="col-md-3"><strong>24h Change:</strong> {row.change}</div>
                      <div className="col-md-3"><strong>Market Cap:</strong> {row.marketCap}</div>
                      <div className="col-md-3"><strong>Trading Volume:</strong> {row.volume}</div>
                      <div className="col-md-6"><strong>Analyst Rating:</strong> {row.rating}</div>
                      <div className="col-md-6"><strong>Market Status:</strong> {row.status}</div>
                    </div>
                  </div>
                )}
                defaultPageSize={10}
