...
export const UtilitiesPage: React.FC = () => {
  return (
    <div className="page-wrapper-module">
      <PageHeader title="Utilities" category="Base UI" />
...
<img alt="rounded" className="avatar-lg rounded" src="assets/images/users/user-2.jpg"/>
<img alt="rounded-top" className="avatar-lg rounded-top" src="assets/images/users/user-2.jpg"/>
<img alt="rounded-end" className="avatar-lg rounded-end" src="assets/images/users/user-2.jpg"/>
<img alt="rounded-bottom" className="avatar-lg rounded-bottom" src="assets/images/users/user-2.jpg"/>
<img alt="rounded-start" className="avatar-lg rounded-start" src="assets/images/users/user-2.jpg"/>
<img alt="rounded-circle" className="avatar-lg rounded-circle" src="assets/images/users/user-2.jpg"/>
<img alt="rounded-pill" className="w-auto rounded-pill" src="assets/images/stock/small-3.jpg" width={80}/>
</div>
</div>
...
<p>
<a className="pe-none" href="#" tabIndex={-1}>This link</a>
                                        can not be clicked.
                                    </p>
<p>
<a className="pe-auto" href="#">This link</a>
...
<div className="d-flex align-items-start flex-wrap gap-2">
<img alt="rounded-0" className="avatar-lg rounded-0" src="assets/images/users/user-4.jpg"/>
<img alt="rounded-1" className="avatar-lg rounded-1" src="assets/images/users/user-4.jpg"/>
<img alt="rounded-2" className="avatar-lg rounded-2" src="assets/images/users/user-4.jpg"/>
<img alt="rounded-3" className="avatar-lg rounded-3" src="assets/images/users/user-4.jpg"/>
<img alt="rounded-4" className="avatar-lg rounded-4" src="assets/images/users/user-4.jpg"/>
<img alt="rounded-5" className="avatar-lg rounded-5" src="assets/images/users/user-4.jpg"/>
</div>
</div>
...
<div className="overflow-visible p-3 bg-light" style={{ maxWidth: '260px', maxHeight: '100px' }}>
                                            This is an example of using
...
<div className="position-relative p-5 bg-light bg-opacity-50 m-3 border rounded" style={{ height: '180px' }}>
...
<div className="position-relative m-3 bg-light bg-opacity-50 border rounded" style={{ height: '180px' }}>
...
<div className="d-flex flex-wrap gap-3 align-items-start" style={{ height: '255px' }}>
...
<div>
<img alt="..." className="object-fit-contain border rounded avatar-xl" src="assets/images/stock/small-1.jpg"/>
<p className="mt-1 mb-0">
<code className="user-select-all">.object-fit-contain</code>
</p>
</div>
<div>
<img alt="..." className="object-fit-cover border rounded avatar-xl" src="assets/images/stock/small-1.jpg"/>
<p className="mt-1 mb-0">
<code className="user-select-all">.object-fit-cover</code>
</p>
</div>
<div>
<img alt="..." className="object-fit-fill border rounded avatar-xl" src="assets/images/stock/small-1.jpg"/>
<p className="mt-1 mb-0">
<code className="user-select-all">.object-fit-fill</code>
</p>
</div>
<div>
<img alt="..." className="object-fit-scale border rounded avatar-xl" src="assets/images/stock/small-1.jpg"/>
<p className="mt-1 mb-0">
<code className="user-select-all">.object-fit-scale</code>
</p>
</div>
<div>
<img alt="..." className="object-fit-none border rounded avatar-xl" src="assets/images/stock/small-1.jpg"/>
<p className="mt-1 mb-0">
...
<div className="position-relative" style={{ height: '220px', zIndex: '1' }}>
