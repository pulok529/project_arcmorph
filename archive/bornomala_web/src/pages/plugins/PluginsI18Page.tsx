...
export const PluginsI18Page: React.FC = () => {
  return (
    <div>
      <PageHeader title="i18 Support" category="Plugins" />

      <div className="row">
        <div className="col-12">
          <Card title="i18 Support Showcase" badge={<span className="badge badge-soft-primary fs-xs">Active</span>}>
            <div className="p-3 bg-light rounded mb-4 d-flex align-items-center gap-3">
              ...
              <div>
                <h5 className="mb-1 fw-bold">i18 Support</h5>
