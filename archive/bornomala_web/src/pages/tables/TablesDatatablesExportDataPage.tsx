...
export const TablesDatatablesExportDataPage: React.FC = () => {
  return (
    <div className="page-wrapper-module">
      <PageHeader title="Export Data" category="Tables" />

      <div className="module-content-body">
        <div className="row g-4">
          {/* Card 1: Export Data with Buttons */}
          <div className="col-12">
            <Card 
              title="Export Data with Buttons" 
              headerAction={
                <a href="https://datatables.net/reference/button/" target="_blank" rel="noreferrer" className="icon-link icon-link-hover link-primary fw-semibold fs-sm">
          ...
          {/* Card 2: Export Data with Dropdowns */}
          <div className="col-12">
            <Card 
              title="Export Data with Dropdowns" 
              headerAction={
                <a href="https://datatables.net/reference/button/" target="_blank" rel="noreferrer" className="icon-link icon-link-hover link-primary fw-semibold fs-sm">
                  View Docs <i className="ti ti-arrow-right bi align-middle fs-lg"></i>
                </a>
...
export default TablesDatatablesExportDataPage;
