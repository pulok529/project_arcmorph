...
export const ChartsEchartSunburstPage: React.FC = () => {
  const option1 = {
    title: { text: 'GEO Maps Overview', left: 'center', textStyle: { color: '#6c757d', fontSize: 14 } },
    ...
    <div>
      ...
      <div className="row">
        <div className="col-lg-6">
          <Card title="Primary GEO Maps">
            <ReactECharts option={option1} style={{ height: 350, width: '100%' }} />
          </Card>
        </div>

        <div className="col-lg-6">
          <Card title="Secondary GEO Maps">
