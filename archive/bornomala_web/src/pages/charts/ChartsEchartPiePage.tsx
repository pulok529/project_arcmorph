...
export const ChartsEchartPiePage: React.FC = () => {
  const option1 = {
    title: { text: 'Pie Echart Overview', left: 'center', textStyle: { color: '#6c757d', fontSize: 14 } },
  ...
  return (
    <div>
      <PageHeader title="Pie Echart" category="Charts" />

      <div className="row">
        <div className="col-lg-6">
          <Card title="Primary Pie Echart">
            <ReactECharts option={option1} style={{ height: 350, width: '100%' }} />
          </Card>
        </div>

        <div className="col-lg-6">
          <Card title="Secondary Pie Echart">
