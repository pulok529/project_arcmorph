...
export const AuthSplitLockScreenPage: React.FC = () => {
  return (
    <div>
      <PageHeader title="Auth Split Lock Screen" category="Authentication" />

      <div className="row">
        <div className="col-12">
          <Card title="Auth Split Lock Screen Showcase" badge={<span className="badge badge-soft-primary fs-xs">Active</span>}>
            <div className="p-3 bg-light rounded mb-4 d-flex align-items-center gap-3">
              ...
              <div>
                <h5 className="mb-1 fw-bold">Auth Split Lock Screen</h5>
