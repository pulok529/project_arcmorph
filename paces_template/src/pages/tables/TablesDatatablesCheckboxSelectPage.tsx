...
export const TablesDatatablesCheckboxSelectPage: React.FC = () => {
  return (
    <div className="page-wrapper-module">
      <PageHeader title="Checkbox Select DataTables" category="Tables" />

      <div className="module-content-body">
        <div className="row">
          <div className="col-12">
            <Card title="Checkbox Select DataTables" badge={<span className="badge badge-soft-primary fs-xs">Live Interactive</span>}>
              <ReactDataTable
