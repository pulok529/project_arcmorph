...
export const TablesDatatablesAjaxPage: React.FC = () => {
  return (
    <div className="page-wrapper-module">
      <PageHeader title="DataTables Ajax" category="Tables" />

      <div className="module-content-body">
        <div className="row">
          <div className="col-12">
            <Card title="DataTables Ajax" badge={<span className="badge badge-soft-primary fs-xs">Live Interactive</span>}>
              <ReactDataTable
