...
export const TablesDatatablesFixedHeaderPage: React.FC = () => {
  return (
    <div className="page-wrapper-module">
      <PageHeader title="Fixed Header DataTables" category="Tables" />

      <div className="module-content-body">
        <div className="row">
          <div className="col-12">
            <Card title="Fixed Header DataTables" badge={<span className="badge badge-soft-primary fs-xs">Live Interactive</span>}>
              <ReactDataTable
