...
export const TablesDatatablesRenderingPage: React.FC = () => {
  return (
    <div className="page-wrapper-module">
      <PageHeader title="Data Rendering DataTables" category="Tables" />

      <div className="module-content-body">
        <div className="row">
          <div className="col-12">
            <Card title="Data Rendering DataTables" badge={<span className="badge badge-soft-primary fs-xs">Live Interactive</span>}>
              <ReactDataTable
