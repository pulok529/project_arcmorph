...
export const TabsPage: React.FC = () => {
  return (
    <div className="page-wrapper-module">
      <PageHeader title="Tabs" category="Base UI" />
...
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#overview">Overview</a>
</li>
<li className="nav-item">
<a aria-expanded={true} className="nav-link active" data-bs-toggle="tab" href="#activity">Activity</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#settings">Settings</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link disabled" data-bs-toggle="tab" href="#">Disabled</a>
</li>
</ul>
<div className="tab-content">
<div className="tab-pane" id="overview">
<p className="mb-0">This dashboard provides a quick overview of your recent activity, performance metrics, and system status. You can easily monitor key indicators, recent logins, pending tasks, and overall user engagement.</p>
</div>
<div className="tab-pane show active" id="activity">
<p className="mb-0">View your latest interactions and actions taken across the platform. This includes recent file uploads, comments, status updates, and notification history to keep you up to date with ongoing changes.</p>
</div>
<div className="tab-pane" id="settings">
<p className="mb-0">Customize your account preferences including theme options, notification settings, and privacy controls. Adjust layout configurations to suit your workflow and manage integration with third-party services.</p>
</div>
</div>
</div>
...
<ul className="nav nav-justified nav-tabs mb-3">
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#overview1">Overview</a>
</li>
<li className="nav-item">
<a aria-expanded={true} className="nav-link active" data-bs-toggle="tab" href="#profile1">Profile</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#settings1">Settings</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#projects1">Projects</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#support1">Support</a>
</li>
</ul>
<div className="tab-content">
<div className="tab-pane" id="overview1">
...
<div className="tab-pane" id="projects1">
...
<div className="tab-pane" id="support1">
...
<div aria-orientation="vertical" className="nav flex-column nav-pills" id="v-pills-tab1" role="tablist">
<a aria-controls="v-pills-home" aria-selected className="nav-link fw-semibold active show" data-bs-toggle="pill" href="#v-pills-home" id="v-pills-home-tab" role="tab">Overview</a>
<a aria-controls="v-pills-profile" aria-selected className="nav-link fw-semibold" data-bs-toggle="pill" href="#v-pills-profile" id="v-pills-profile-tab" role="tab">Profile</a>
<a aria-controls="v-pills-settings" aria-selected className="nav-link fw-semibold" data-bs-toggle="pill" href="#v-pills-settings" id="v-pills-settings-tab" role="tab">Settings</a>
<a aria-controls="v-pills-projects" aria-selected className="nav-link fw-semibold" data-bs-toggle="pill" href="#v-pills-projects" id="v-pills-projects-tab" role="tab">Projects</a>
<a aria-controls="v-pills-support" aria-selected className="nav-link fw-semibold" data-bs-toggle="pill" href="#v-pills-support" id="v-pills-support-tab" role="tab">Support</a>
</div>
</div>
<div className="col-sm-9">
<div className="tab-content" id="v-pills-tabContent">

<div aria-labelledby="v-pills-home-tab" className="tab-pane fade active show" id="v-pills-home" role="tabpanel">
...
<div aria-labelledby="v-pills-profile-tab" className="tab-pane fade" id="v-pills-profile" role="tabpanel">
...
<div aria-labelledby="v-pills-settings-tab" className="tab-pane fade" id="v-pills-settings" role="tabpanel">
...
<div aria-labelledby="v-pills-projects-tab" className="tab-pane fade" id="v-pills-projects" role="tabpanel">
...
<div aria-labelledby="v-pills-support-tab" className="tab-pane fade" id="v-pills-support" role="tabpanel">
...
<div aria-labelledby="v-pills-home-tab" className="tab-pane fade active show" id="v-pills-home-right" role="tabpanel">
<p className="mb-2">Welcome to your dashboard. Get an at-a-glance view of your recent activity, top stats, and personalized suggestions to enhance productivity and stay on track.</p>
<ul>
<li>View total project status</li>
<li>Quick links to recent files</li>
...
<div aria-labelledby="v-pills-profile-tab" className="tab-pane fade" id="v-pills-profile-right" role="tabpanel">
<p className="mb-2">Manage your personal details, change your profile photo, and update your contact information.</p>
<ul>
<li>Name, Email, Phone</li>
<li>Change Password</li>
...
<div aria-labelledby="v-pills-settings-tab" className="tab-pane fade" id="v-pills-settings-right" role="tabpanel">
<p className="mb-2">Customize your preferences, notification options, and privacy settings.</p>
<ul>
<li>Theme selection: Light / Dark mode</li>
<li>Email &amp; push notification toggles</li>
...
<div aria-labelledby="v-pills-projects-tab" className="tab-pane fade" id="v-pills-projects-right" role="tabpanel">
<p className="mb-2">Track all your active, completed, and upcoming projects in one place.</p>
<ul>
<li>Kanban board and Gantt charts</li>
<li>Task assignments and deadlines</li>
...
<div aria-labelledby="v-pills-support-tab" className="tab-pane fade" id="v-pills-support-right" role="tabpanel">
<p className="mb-2">Need assistance? Access our help center or contact our support team directly.</p>
<ul>
<li>Browse FAQs and tutorials</li>
<li>Submit a support ticket</li>
...
<div aria-orientation="vertical" className="nav flex-column nav-pills nav-pills-secondary" id="v-pills-tab" role="tablist">
<a aria-controls="v-pills-home" aria-selected className="nav-link fw-semibold active show" data-bs-toggle="pill" href="#v-pills-home-right" id="v-pills-home-tab-right" role="tab">Overview</a>
<a aria-controls="v-pills-profile" aria-selected className="nav-link fw-semibold" data-bs-toggle="pill" href="#v-pills-profile-right" id="v-pills-profile-tab-right" role="tab">Profile</a>
<a aria-controls="v-pills-settings" aria-selected className="nav-link fw-semibold" data-bs-toggle="pill" href="#v-pills-settings-right" id="v-pills-settings-tab-right" role="tab">Settings</a>
<a aria-controls="v-pills-projects" aria-selected className="nav-link fw-semibold" data-bs-toggle="pill" href="#v-pills-projects-right" id="v-pills-projects-tab-right" role="tab">Projects</a>
<a aria-controls="v-pills-support" aria-selected className="nav-link fw-semibold" data-bs-toggle="pill" href="#v-pills-support-right" id="v-pills-support-tab-right" role="tab">Support</a>
</div>
</div>
</div>
...
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#home-b1">Home</a>
</li>
<li className="nav-item">
<a aria-expanded={true} className="nav-link active" data-bs-toggle="tab" href="#profile-b1">Profile</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#settings-b1">Settings</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#about-b1">About</a>
</li>
</ul>
<div className="tab-content">
...
<div className="tab-pane" id="about-b1">
<p className="mb-0">
...
<ul className="nav nav-tabs nav-justified nav-bordered nav-bordered-danger mb-3">
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#home-b2">
<i className="ti ti-smart-home fs-lg me-md-1 align-middle"></i>
<span className="d-none d-md-inline-block align-middle">Home</span>
</a>
</li>
<li className="nav-item">
<a aria-expanded={true} className="nav-link active" data-bs-toggle="tab" href="#profile-b2">
<i className="ti ti-user-circle fs-lg me-md-1 align-middle"></i>
<span className="d-none d-md-inline-block align-middle">Profile</span>
</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#settings-b2">
<i className="ti ti-settings fs-lg me-md-1 align-middle"></i>
<span className="d-none d-md-inline-block align-middle">Settings</span>
</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#about-b2">
<i className="ti ti-alert-octagon fs-lg me-md-1 align-middle"></i>
<span className="d-none d-md-inline-block align-middle">About</span>
</a>
</li>
</ul>
<div className="tab-content">
...
<div className="tab-pane" id="settings-b2">
<p className="mb-0">
...
<div className="tab-pane" id="about-b2">
<p className="mb-0">
...
<ul className="nav nav-tabs nav-bordered nav-bordered-success mb-3">
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#home-i1">
<i className="ti ti-smart-home fs-22 align-middle"></i>
</a>
</li>
<li className="nav-item">
<a aria-expanded={true} className="nav-link active" data-bs-toggle="tab" href="#profile-i1">
<i className="ti ti-user-circle fs-22 align-middle"></i>
</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#settings-i1">
<i className="ti ti-settings fs-22 align-middle"></i>
</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#about-i1">
<i className="ti ti-alert-octagon fs-22 align-middle"></i>
</a>
</li>
</ul>
<div className="tab-content">
<div className="tab-pane" id="home-i1">
...
<div className="tab-pane show active" id="profile-i1">
...
<div className="tab-pane" id="settings-i1">
...
<div className="tab-pane" id="about-i1">
...
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#home-ct">
<i className="ti ti-smart-home fs-22 d-md-none d-block"></i>
<span className="d-none d-md-block">Summary</span>
</a>
</li>
<li className="nav-item">
<a aria-expanded={true} className="nav-link active" data-bs-toggle="tab" href="#profile-ct">
<i className="ti ti-user-circle fs-22 d-md-none d-block"></i>
<span className="d-none d-md-block">Accounts</span>
</a>
</li>
<li className="nav-item">
<a aria-expanded={false} className="nav-link" data-bs-toggle="tab" href="#settings-ct">
<i className="ti ti-settings fs-22 d-md-none d-block"></i>
...
<div className="card-body">
<div className="tab-content">
<div className="tab-pane" id="home-ct">
<p className="mb-0">
...
<div className="tab-pane show active" id="profile-ct">
...
<div className="tab-pane" id="settings-ct">
