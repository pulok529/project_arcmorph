...
export const ScrollspyPage: React.FC = () => {
  return (
    <div className="page-wrapper-module">
      <PageHeader title="Scrollspy" category="Base UI" />
...
<h4 className="card-title">Example in Navbar</h4>
</div>
...
<nav className="navbar navbar-light bg-light px-3" id="navbar-example2">
...
<a aria-expanded={false} aria-haspopup="true" className="nav-link dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" role="button">
                                                    Dropdown
...
<div className="overflow-auto mt-2 position-relative" data-bs-offset="0" data-bs-spy="scroll" data-bs-target="#navbar-example2" style={{ height: '200px' }}>
<h4 id="fat">@fat</h4>
<p>
...
<div className="card-header">
<div className="flex-grow-1">
<h4 className="card-title">Example with Nested Nav</h4>
</div>
<div className="card-action">
<a className="card-action-item" data-action="card-toggle" href="#!">
<i className="ti ti-chevron-up align-middle"></i>
...
<div className="overflow-auto mt-2 position-relative" data-bs-offset="0" data-bs-spy="scroll" data-bs-target="#navbar-example3" style={{ height: '300px' }}>
...
<div className="card-header">
<div className="flex-grow-1">
<h4 className="card-title">Example with List Group</h4>
</div>
<div className="card-action">
<a className="card-action-item" data-action="card-toggle" href="#!">
<i className="ti ti-chevron-up align-middle"></i>
...
<div className="col-10">
<div className="overflow-auto mt-2 position-relative" data-bs-offset="0" data-bs-spy="scroll" data-bs-target="#list-example" style={{ height: '200px' }}>
