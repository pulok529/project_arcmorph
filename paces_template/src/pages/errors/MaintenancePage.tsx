...
export const MaintenancePage: React.FC = () => {
  return (
    <div>
      <PageHeader title="Maintenance" category="Error Pages" />

      <div className="row">
        <div className="col-lg-8">
          <Card title="Maintenance Overview" badge={<span className="badge badge-soft-primary fs-xs">Active</span>}>
            <div className="d-flex align-items-center gap-3 p-3 bg-light rounded mb-4">
              <span className="avatar-md bg-primary text-white rounded d-flex align-items-center justify-content-center" style={{ width: 48, height: 48 }}>
                <i className="ti-tools fs-24"></i>
              </span>
              <div>
                <h5 className="mb-1 fw-bold">Maintenance Component</h5>
                <p className="text-muted mb-0 fs-sm">System maintenance is currently in progress. We will be back shortly.</p>
              </div>
            </div>
